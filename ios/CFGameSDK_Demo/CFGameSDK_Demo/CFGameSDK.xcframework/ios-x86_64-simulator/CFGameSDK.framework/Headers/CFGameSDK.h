...
#import <CFGameSDK/CFCommonHeader.h>

//! Project version number for CFGameSDK.
FOUNDATION_EXPORT double CFGameSDKVersionNumber;

//! Project version string for CFGameSDK.
FOUNDATION_EXPORT const unsigned char CFGameSDKVersionString[];
